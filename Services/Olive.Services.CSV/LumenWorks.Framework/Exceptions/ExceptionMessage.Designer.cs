...
namespace LumenWorks.Framework.IO.Csv.Resources
{
    ...
    internal class ExceptionMessage
    {
        ...
        /// </summary>
        internal static string BufferSizeTooSmall => "Buffer size must be 1 or more.";
        ...
        internal static string CannotMovePreviousRecordInForwardOnly
        {
            get
            {
                return "Cannot move to a previous record in forward-only mode.";
            }
        }
        ...
        /// </summary>
        internal static string CannotReadRecordAtIndex => "Cannot read record at index '{0}'.";
        ...
        /// </summary>
        internal static string FieldHeaderNotFound => "'{0}' field header not found.";
        ...
        internal static string FieldIndexOutOfRange
        {
            get
            {
                return "Field index must be included in [0, FieldCount[. Specified field index was : '{0}'.";
            }
        }
        ...
        internal static string MalformedCsvException
        {
            get
            {
                return "The CSV appears to be corrupt near record '{0}' field '{1} at position '{2}'. Current raw data : '{3}'.";
            }
        }
        ...
        internal static string MissingFieldActionNotSupported
        {
            get
            {
                return "'{0}' is not a supported missing field action.";
            }
        }
        ...
        /// </summary>
        internal static string NoCurrentRecord => "No current record.";
        ...
        internal static string NoHeaders
        {
            get
            {
                return "The CSV does not have headers (CsvReader.HasHeaders property is false).";
            }
        }
        ...
        internal static string NotEnoughSpaceInArray
        {
            get
            {
                return "The number of fields in the record is greater than the available space from index to the end of the destination array.";
            }
        }
        ...
        internal static string ParseErrorActionInvalidInsideParseErrorEvent
        {
            get
            {
                return "'{0}' is not a valid ParseErrorAction while inside a ParseError event.";
            }
        }
        ...
        /// </summary>
        internal static string ReaderClosed => "This operation is invalid when the reader is closed.";

        /// <summary>
        ///   Looks up a localized string similar to Record index must be 0 or more..
        /// </summary>
        internal static string RecordIndexLessThanZero => "Record index must be 0 or more.";
    }
}
