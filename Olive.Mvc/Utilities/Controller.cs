...
namespace Olive.Mvc
{
    ...
    public abstract partial class Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        ///  by using the specified view name and model.</summary>
        public new virtual PartialViewResult PartialView(string viewName, object model) => base.PartialView(viewName, model);
    }
