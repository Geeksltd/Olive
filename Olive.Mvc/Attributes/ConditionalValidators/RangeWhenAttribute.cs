namespace Olive.Mvc
{
    ...
    public class RangeWhenAttribute : RangeAttribute
    {
        ...
        public RangeWhenAttribute(double minimum, double maximum, string propertyName = null)
        ...
        /// </summary>
        /// <param name="propertyName">The boolean property`s name which will be checked before validating.</param>
        public RangeWhenAttribute(int minimum, int maximum, string propertyName = null)
            : base(minimum, maximum) => PropertyName = propertyName;
        ...
        /// </summary>
        /// <param name="propertyName">The boolean property`s name which will be checked before validating.</param>
        public RangeWhenAttribute(Type type, string minimum, string maximum, string propertyName = null)
