namespace Olive.Entities.Data
{
    ...
    class PostgreSqlCriterionGenerator
    {
        DatabaseQuery Query;
        Type EntityType;
        ...
        string Generate(DirectDatabaseCriterion criterion)
        {
            ...
            if (criterion.Parameters != null)
                foreach (var x in criterion.Parameters) Query.Parameters.Add(x.Key, x.Value);
        ...
        {
            var result = column.Remove("[").Remove("]").Replace(".", "_").Replace("\"", "");
