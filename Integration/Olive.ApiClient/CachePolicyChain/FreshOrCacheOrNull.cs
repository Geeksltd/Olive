...
namespace Olive
{
    public class FreshOrCacheOrNull<T> : GetResponse<T>
    {
        ...
        public FreshOrCacheOrNull(ApiClient apiClient, string url, CachePolicy cachePolicy, TimeSpan? cacheExpiry,
        ...
        {
            if (_cachePolicy == CachePolicy.FreshOrCacheOrNull)
                try
                {
